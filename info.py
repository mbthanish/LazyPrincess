...
BOT_TOKEN = environ.get('BOT_TOKEN', '6913155607:AAEy6nRTrKstufIWo4YvFlgtE3NbNOX4oV0')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://lazy:lazy@cluster0.ddynptz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002098875945'))
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "🎦<b>: </b> ➥  {file_name} \n⚙️ <b>: </b><i>{file_size}</i>\n\n  </b>Join: @FilimCompanyRequest3</b>")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", CUSTOM_FILE_CAPTION)
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>Your Query: {query}</b> \n‌‌‌‌IMDb Data \n\n🏷 Title: <a href={url}>{title}</a>\n🎭 Genres: {genres}\n📆 Year: <a href={url}/releaseinfo>{year}</a>\n🌟 Rating: <a href={url}/ratings>{rating}</a> </b>")
...
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "Filimcompanyrequest3") #[ without @ ]
